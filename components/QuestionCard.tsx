...
export default function QuestionCard({
    q, index, paperId, examSlug, syllabusEntries, onUpdate, onDelete
}: {
    q: Question; index: number; paperId: string | null; examSlug: string;
    syllabusEntries: SyllabusEntry[]; onUpdate: (updated: Question) => void; onDelete: () => void;
}) {
    ...
    return (
        <div className={`rounded-2xl border transition-all duration-200 overflow-hidden ${q.saved ? "border-slate-200 bg-white shadow-sm" : "border-blue-200 bg-blue-50/30 shadow-sm"}`}>
