                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 bg-card p-8 rounded-2xl border border-border shadow-sm">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <select
                                                {...field}
                                                className="w-full h-10 px-3 rounded-md border border-border bg-card text-sm focus:ring-2 focus:ring-ring outline-none transition-all"
                                            >
                        ...
                        <div className="space-y-6 pt-6 border-t">
                            <div className="flex items-center justify-between">
                                ...
                                <Button type="button" variant="outline" size="sm" onClick={() => append({ category: "", topics: [] })} className="rounded-lg font-bold border-border">
                            ...
                            {fields.map((field, index) => (
                                <div key={field.id} className="relative pt-2"> {/* Wrapper to handle the icon "pop-out" */}
                                    ...
                                    <div className="absolute top-0 right-0 flex justify-end">
                                        <div className="bg-card border border-border border-b-0 rounded-t-xl px-2 py-1 flex items-center shadow-[0_-2px_4px_rgba(0,0,0,0.02)]">
                                            <Button
                                                type="button"
                                                variant="ghost"
                                                size="icon"
                                    ...
                                    <Card className="p-6 space-y-4 border-border bg-card shadow-sm rounded-xl rounded-tr-none">
                                        <FormField
                                            control={form.control}
                                                ...
                                                <FormItem className="space-y-0">
                                                    <FormControl>
                                                        <Input
                                                            ...
                                                            {...field}
                                                            className="font-bold text-foreground/80 bg-card border-border h-11 focus-visible:ring-ring"
                                                        />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                                ...
                                                <FormItem className="space-y-0">
                                                    <FormControl>
                                                        <Textarea
                                                            ...
                                                            className="bg-card resize-none text-sm border-border min-h-[100px] focus-visible:ring-ring"
                                                        />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
