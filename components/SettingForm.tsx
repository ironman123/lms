    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 space-y-5">
                ...
                <div>
                    <label className="text-xs font-black text-slate-400 uppercase tracking-wider block mb-1.5">Name</label>
                    <input
                        type="text"
                        value={name}
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 space-y-4">
                <div className="flex items-center justify-between">
                    <h2 className="text-sm font-black text-slate-900 uppercase tracking-widest">Target Exams</h2>
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    selected ? "border-slate-900 bg-slate-50" : "border-slate-100 hover:border-slate-200"
                                )}
                            >
                                {selected ? (
                                ...
                                <div className="min-w-0">
                                    ...
                                    {exam.examCategory && (
                                        <p className="text-[10px] text-slate-400">{exam.examCategory.name}</p>
                                    )}
                                </div>
                            </button>
                        );
